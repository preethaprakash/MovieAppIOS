...
class TopRatedCollectionViewController: UICollectionViewController {
    ...
    @IBOutlet var topRatedMovieCollectionViewController: UICollectionView!
    
    let imageURL="http://image.tmdb.org/t/p/w500/"
    let reuseIdentifier = "TopCell"
    ...
    override func viewDidLoad() {
        ...
        super.viewDidLoad()
        self.navigationController?.navigationBar.topItem?.title = "TopRated"
        ...
        TopRatedCollectionViewController.loaded=1
        
    }
    override func viewWillTransitionToSize(size: CGSize, withTransitionCoordinator coordinator: UIViewControllerTransitionCoordinator) {
        print("uuu")
        if TopRatedCollectionViewController.loaded==1{
        if UIDevice.currentDevice().orientation.isLandscape.boolValue {
            self.topRatedMovieCollectionViewController.reloadData()
        } else {
            self.topRatedMovieCollectionViewController.reloadData()
        }
        }
    ...
    override func collectionView(collectionView: UICollectionView, cellForItemAtIndexPath indexPath: NSIndexPath) -> UICollectionViewCell {
        ...
        cell.topimageVar.kf_setImageWithURL(tempUrl!,placeholderImage: nil)
        cell.alpha = 0
